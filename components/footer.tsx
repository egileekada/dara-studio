    ...
    return(
        <div className=" w-full py-7 flex flex-col px-6 text-white " >
            <div className=" w-full flex justify-between lg:justify-center mx-auto items-center " >  
                ...
                <div className=" flex items-center lg:flex-row flex-col " > 
                    <a href="#" className="mx-3" ><img alt="footer" src="/images/Snapchat.png" className=" w-5 h-5 "  /></a>
                    <a href="#" className="mx-3" ><img alt="footer" src="/images/Instagram.png" className=" w-5 h-5 "  /></a>
                    <a href="#" className="mx-3" ><img alt="footer" src="/images/Twitter.png" className=" w-5 h-5 "  /></a>
                </div>
            </div> 
