    ...
    return( 
        <div className={tab ? ' w-full flex justify-between items-center fixed px-6 lg:px-12 z-40 py-3 lg:py-6 text-white top-0 ' : ' w-full flex justify-between items-center fixed px-6 lg:px-12 z-40 py-3 lg:py-6 bg-black bg-opacity-30 text-white top-0 '} > 
            ...
            <div className=' hidden lg:flex ' > 
                ...
                <button onClick={()=> {Router.push("http://wa.me/2348035583369"), setTab(false)}} className={props.tab === "chat" ? ' mx-6 w-20 h-9 flex justify-center items-center Raleway-600 border border-[#FF9B05] ' : ' mx-6 w-20 h-9 flex justify-center items-center Raleway-600 '} >Let’s talk</button>
            </div>
            {tab &&  
                <div className=' fixed inset-0 bg-black z-40 w-full flex flex-col items-center bg-opacity-60 justify-center ' >
                    ...
                    <button onClick={()=> {Router.push("http://wa.me/2348035583369"), setTab(false)}} className={props.tab === "chat" ? ' lg:text-base text-lg my-6 w-20 h-11 flex justify-center items-center Raleway-600 border border-[#FF9B05] ' : ' lg:text-base text-lg my-6 w-20 h-11 flex justify-center items-center Raleway-600 '} >Let’s talk</button>
                </div>
            }
        </div> 
    )
