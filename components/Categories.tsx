    ...
    return (
        <div className="w-full overflow-x-auto flex overflow-y-hidden"  >
            <div className=' flex lg:w-full ' > 
                <div className="lg:w-full w-[400px] lg:h-full  relative"  > 
                    <img src="/images/1.png" className=" lg:w-full w-[400px] object-cover "  />
                    <div className=" absolute flex items-center z-20 bottom-24 lg:bottom-20 lg:pb-6 left-4 "  >
                ...
                <div className="lg:w-full w-[400px] relative"  > 
                    <img src="/images/2.png" className="lg:w-full w-[400px]  object-cover" />
                    <div className=" absolute flex items-center  bottom-24 lg:bottom-20 lg:pb-6 left-4 "  >
                ...
                <div className="lg:w-full w-[400px]  relative"  > 
                    <img src="/images/3.png" className="lg:w-full w-[400px]  object-cover" />
                    <div className=" absolute flex items-center  bottom-24 lg:bottom-20 lg:pb-6 left-4 "  >
                        <p className="font-Poppins-ExtraBold text-4xl text-[#FFFFFF66]"  >01</p>
                ...
                <div className="lg:w-full w-[400px]  relative"  > 
                    <img src="/images/4.png" className="lg:w-full w-[400px]  object-cover" />
                    <div className=" absolute flex items-center  bottom-24 lg:bottom-20 lg:pb-6 left-4 "  >
                        <p className="font-Poppins-ExtraBold text-4xl text-[#FFFFFF66]"  >01</p>
