...
export default function Categories() {
    return (
        <div className="w-full overflow-x-auto h-[90vh] flex overflow-y-hidden"  >
            <div className=' flex lg:w-full ' > 
                <div className="lg:w-full w-[400px] h-full  relative"  > 
                    <img src="/images/1.png" className=" lg:w-full w-full h-full object-cover "  />
                    <div className=" absolute flex items-center z-20 bottom-32 lg:bottom-12 lg:pb-6 left-4 "  >
                ...
                <div className="lg:w-full w-[400px] relative"  > 
                    ...
                    <div className=" absolute flex items-center  bottom-32 lg:bottom-12 lg:pb-6 left-4 "  >
