...
export default function AboutUs() {
    return ( 
        <div className="  lg:mt-0 mt-1 lg:pb-0 pb-28 lg:ppx-0 px-6 bg-[#121212] overflow-y-auto w-full h-full flex lg:flex-row flex-col items-center  " > 
            <div className=' w-full flex lg:mt-0   ' > 
                <img  src="/images/About1.png" alt='one' className=' w-full object-cover ' /> 
            </div> 
            <div className=' w-full flex  text-white h-fit flex-col ' >
